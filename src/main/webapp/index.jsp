        ...
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
            ...
            <ul class="d-flex justify-content-end list-unstyled m-0">
              <li>
                <a href="MvcModel2/Login/LoginHome.jsp" class="rounded-circle bg-light p-2 mx-1">
                ...
                <div class="offcanvas-body">
                  ...
                  <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                    <li class="nav-item active">
                      <a href="../mvc/boardlist.do" class="nav-link">자유게시판</a>
                    </li>
                    <li class="nav-item dropdown">
                      <a href="../mvc/filelist.do" class="nav-link">자료실</a>
                    </li>
                    <li class="nav-item">
                      <a href="../mvc/commendlist.do" class="nav-link">Q&A게시판</a>
                    </li>
                  </ul>
